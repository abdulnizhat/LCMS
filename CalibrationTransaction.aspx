                                ...
                                <div class="col-md-4">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlScheduleID" TabIndex="1" runat="server" OnSelectedIndexChanged="ddlScheduleID_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control">
                                                        </asp:DropDownList>
                                        ...
                                        <div class="form-group" id="divTolGo" runat="server">
                                            <asp:Label runat="server" CssClass="col-md-4 control-label">Tollerance Go<b style="color: Red">*</b></asp:Label>
                                            <div class="col-md-8">
                                                ...
                                                <asp:RequiredFieldValidator ValidationGroup="c" Display="Dynamic" runat="server" ControlToValidate="txtTolleranceGo"
                                                    CssClass="text-danger" SetFocusOnError="true" ErrorMessage="Tollerance Go field is required." />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="divTolNoGo" runat="server">
                                            <asp:Label runat="server" CssClass="col-md-4 control-label">Tollerance No Go<b style="color: Red">*</b></asp:Label>
                                            <div class="col-md-8">
                                                ...
                                                <asp:RequiredFieldValidator ValidationGroup="c" Display="Dynamic" runat="server" ControlToValidate="txtTolleranceNoGo"
                                                    CssClass="text-danger" SetFocusOnError="true" ErrorMessage="Tollerance No Go field is required." />
                                            </div>
                                        </div>
