<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CalibrationSchedule.aspx.cs" Inherits="CalibrationSchedule" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h3><%: Title %>Calibration Schedule</h3>
                                ...
                                <asp:Panel ID="pnlgag" runat="server" Width="100%" ScrollBars="Auto">
                                    <asp:GridView ID="grdCalibrationSchedule"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="gauge_sr_no" HeaderText="Gauge Sr.No" ItemStyle-Wrap="false" />
                                            ...
                                            <asp:BoundField DataField="supplier_name" HeaderText="Calibrated By" />
                                            ...
                                            <asp:BoundField DataField="calibration_hours" HeaderText="Calib. Hours" />
                                                    ...
                                                    <asp:UpdatePanel ID="updd" runat="server">
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:LinkButton ID="btnEditCalibSchedule" Enabled="false" runat="server" OnClick="btnEditCalibSchedule_Click"
                                                                CommandArgument='<%# Eval("calibration_schedule_id")%>' class="btn btn-sm btn-info"
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Calibration Schedule Id</asp:Label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlGaugeID" runat="server" OnSelectedIndexChanged="ddlGaugeID_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control">
                                            </asp:DropDownList>
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Last Calibratted By<b style="color: Red">*</b></asp:Label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Calibratted By<b style="color: Red">*</b></asp:Label>
                                <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Calibration Frequency<b style="color: Red">*</b></asp:Label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Last Calibration Date<b style="color: Red">*</b></asp:Label>
                                <div class="col-md-8">
                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="c" SetFocusOnError="true" Display="Dynamic" runat="server" ControlToValidate="txtLastCalibrationDate"
                                                CssClass="text-danger" ErrorMessage="Last Calibration Date field is required." />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="visibility: hidden">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" TabIndex="10" MaxLength="3" ReadOnly="true" ID="txtBias" onkeypress="return onlyNos(event,this);" CssClass="form-control" />
                            ...
                            <div class="form-group" style="visibility: hidden">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" TabIndex="11" MaxLength="3" ID="txtLinearity" ReadOnly="true" onkeypress="return onlyNos(event,this);" CssClass="form-control" />
                            ...
                            <div class="form-group" style="visibility: hidden">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" MaxLength="3" TabIndex="12" ID="txtSatability" ReadOnly="true" onkeypress="return onlyNos(event,this);" CssClass="form-control" />
