                        ...
                        <div class="col-md-6">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" runat="server" id="divSize">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox runat="server" TabIndex="5" ID="txtSize" CssClass="form-control" />
                                        ...
                                        <asp:FilteredTextBoxExtender ID="txtSize_FilteredTextBoxExtender"
                                            runat="server" Enabled="True" TargetControlID="txtSize"
