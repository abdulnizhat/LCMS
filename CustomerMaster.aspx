                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <asp:Label runat="server" CssClass="col-md-4 control-label">Mobile Number<b style="color: Red">*</b></asp:Label>
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtMobile" MaxLength="10" TabIndex="6" onkeypress="return onlyNos(event,this);" CssClass="form-control" />
