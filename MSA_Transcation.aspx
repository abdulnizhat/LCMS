                        ...
                        <asp:Panel ID="Panel1" runat="server" Width="100%" ScrollBars="Auto">
                            <div class="col-md-4">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                ...
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlGauge" TabIndex="1" runat="server" OnSelectedIndexChanged="ddlGauge_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control">
                                                    </asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" CssClass="col-md-4 control-label">Temprature</asp:Label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" CssClass="col-md-4 control-label">Humidity</asp:Label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" CssClass="col-md-4 control-label">Pressure</asp:Label>
                                        <div class="col-md-8">
